"use strict";
class Player {
    constructor(x, y, size, color, speed, board) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.color = color;
...
var TileType;
(function (TileType) {
    TileType[TileType["EMMPTY"] = 0] = "EMMPTY";
    TileType[TileType["PLAYER"] = 1] = "PLAYER";
...
class Game {
    constructor() {
        ...
        this.player = new Player(this.canvas.width / 2 - 20, this.canvas.height / 2 - 20, 40, '#007bff', 5, this.board);
