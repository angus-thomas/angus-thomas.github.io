...
// ===== Helper functions =====
function toFloat32TextureArray(vec3s) {
...
function createProgramFromSources(gl, vertSource, fragSource) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let fragmentShaderResponse = yield fetch(RESOURCES_LIB + "/js/particles/" + fragSource);
        let fragmentShaderSource = yield fragmentShaderResponse.text();
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const velocityUpdateProgram = yield createProgramFromSources(gl, "passThrough.vert", "updateVelocity.frag");
        const positionUpdateProgram = yield createProgramFromSources(gl, "passThrough.vert", "updatePosition.frag");
