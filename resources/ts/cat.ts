...
type SpriteData = {
	...
	backgroundPositions_walk: string[];
	backgroundPosition_sleep: string;
	backgroundPosition_pat: string;
};


function loadSpriteSheet(
	path: string,
	sourceSpritesheetWidthPx: number,
	sourceSpritesheetHeightPx: number,
	sourceSpriteWidthPx: number,
	sourceSpriteHeightPx: number,
	...
	function getPosition(frameIndex: number): string {
...
class Cat {
	...
	targetX: number;
	targetY: number;
	state: CatState = CatState.ASLEEP;
